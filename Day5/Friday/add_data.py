...
def insert_to_tweet_table(dbName: str, df: pd.DataFrame, table_name: str) -> None:
    ...
    for _, row in df.iterrows():
        sqlQuery = f"""INSERT INTO {table_name} (created_at, source, original_text, polarity, subjectivity, lang,
                    favorite_count, retweet_count, original_author, screen_name, followers_count, friends_count,
                    hashtags, user_mentions, place,score,hour,day)
...
if __name__ == "__main__":
    ...
    df = pd.read_csv(r'C:\Users\blais\Desktop\10-Academy\Task5\Friday\finalTweetAnalysis.csv')
